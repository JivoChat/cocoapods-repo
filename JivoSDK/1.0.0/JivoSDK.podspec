Pod::Spec.new do |spec|
  ...
  # spec.source       = { :git => "" }
  spec.ios.vendored_frameworks = 'Products/JivoSDK.framework'
  spec.resource_bundles = { 'JivoSDK' => ['Resources/Assets.xcassets', 'Resources/LocaleBundles/*.lproj'] }
  ...
  spec.user_target_xcconfig = {
    'SWIFT_INCLUDE_PATHS' => '"\$(PODS_ROOT)/JivoSDK.framework"',
    'EXCLUDED_ARCHS[sdk=iphonesimulator*]' => 'arm64'
  }
...
# JMSpecsRepo dependencies
  spec.dependency      'JMShared', '1.0.2'
  spec.dependency      'JMCodingKit', '5.0.1'
  spec.dependency      'JMRepicKit', '1.0.1'
  spec.dependency      'JMTimelineKit', '1.0.5'
